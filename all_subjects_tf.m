function all_subjects_tf(freq_range, baseline)

channels={'E30', 'E31', 'E36', 'E37', 'E41', 'E42', 'E53', 'E54', 'E79', 'E80', 'E86', 'E87', 'E93', 'E103', 'E104', 'E105'};
conditions={'movement','happy','sad','shuffled'};
...
for j=1:length(included_subjects)
    ...
    subj_dir=fullfile('/data','infant_9m_face_eeg','preprocessed',num2str(subj_id), 'ica_optimized4');

    subj_tf=[];
    for k=1:length(conditions)
        data=pop_loadset(fullfile(subj_dir, [num2str(subj_id) '.' conditions{k} '.nomove.set']));    
        cond_x=[];
